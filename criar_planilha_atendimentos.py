...
ws.conditional_formatting.add("D3", CellIsRule(operator="lessThan", formula=["0"], fill=PatternFill("solid", fgColor=red_fill), font=Font(color=red_font, bold=True)))
...
resumo.conditional_formatting.add("B6", CellIsRule(operator="lessThan", formula=["0"], fill=PatternFill("solid", fgColor=red_fill), font=Font(color=red_font, bold=True)))
